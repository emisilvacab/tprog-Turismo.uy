...
public class ControladorUsuario implements IControladorUsuario {
	...
	public DTUsuario iniciarSesion(String ident, String pass) throws ingresoInvalidoException {
		...
		if (!matcher.matches()) {
			...
			if (turista != null && turista.getContrasena().equals(pass)) 
				...
				if (proveedor != null && proveedor.getContrasena().equals(pass)) 
					...
					throw new ingresoInvalidoException("Datos de usuario incorrectos");
			}
		}
		else {
