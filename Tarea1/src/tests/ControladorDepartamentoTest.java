	...
	void testAltaActividad() {
		...
		try {			
			...
			assertThrows(departamentoNoExisteException.class, () -> {
				icd.ingresarDatosActividad("Caza", "Como en la inquisicion pero en 2022", 2, 1, "Cadiz", fechaAlta, "gardelito", "CABA", categorias);
			});
			assertThrows(proveedorNoExisteException.class, () -> {
				icd.ingresarDatosActividad("Caza", "Como en la inquisicion pero en 2022", 2, 1, "Cadiz", fechaAlta, "sinProv", "Maldonado", categorias);
			});
			ingresado = icd.ingresarDatosActividad("Caza de brujas", "Como en la inquisicion pero en 2022", 2, 1, "Cadiz", fechaAlta, "gardelito", "Maldonado", categorias);
