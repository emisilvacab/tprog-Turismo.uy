...
public class CargarDatos {
	...
	public CargarDatos(IControladorUsuario picu, IControladorDepartamento picd) {
		...
		try {
			...
			JOptionPane.showMessageDialog( null, e.getMessage(), "Alta Usuario", JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		icd.ingresarDepartamento("Rivera", "Promociona e implementa proyectos e iniciativas sostenibles de inter´es turístico con la participación institucional póblica – privada en bien del desarrollo socioeconómico de la comunidad.", "www.rivera.gub.uy/social/turismo/");
		...
		try { 
			...
			JOptionPane.showMessageDialog(null, e1.getMessage(), "El departamento seleccionado no estÃ¡ registrado en el sistema", JOptionPane.ERROR_MESSAGE);
		}
		catch(proveedorNoExisteException e2) {
			JOptionPane.showMessageDialog(null, e2.getMessage(), "El proveedor ingresado no estÃ¡ registrado en el sistema", JOptionPane.ERROR_MESSAGE);
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(null, e1.getMessage(), "La actividad seleccionada no estÃ¡ registrada en el sistema", JOptionPane.ERROR_MESSAGE);
		}
		catch(proveedorNoExisteException e2) {
			JOptionPane.showMessageDialog(null, e2.getMessage(), "El proveedor seleccionado no estÃ¡ registrado en el sistema", JOptionPane.ERROR_MESSAGE);
		}	
		...
		try {
			...
			JOptionPane.showMessageDialog(null, e1.getMessage(), "La salida seleccionada no estÃ¡ registrada en el sistema", JOptionPane.ERROR_MESSAGE);
		}
		catch(usuarioNoExisteException e2) {
			JOptionPane.showMessageDialog(null, e2.getMessage(), "El usuario ingresado no estÃ¡ registrado en el sistema", JOptionPane.ERROR_MESSAGE);
		}	
