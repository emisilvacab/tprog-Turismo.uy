	...
	private void mostrarActividad() {
		if (comboBoxDepartamento.getSelectedItem() != null && actividadSeleccionada != null) {
			try {
				...
				try {	
					categorias = cDpto.obtenerCategoriasActividad(actividad.getNombre());
				}catch (actividadNoExisteException actividadNoExiste) {
					JOptionPane.showMessageDialog(null, actividadNoExiste.getMessage(), "Actividad inv·lida", JOptionPane.ERROR_MESSAGE);
				}
